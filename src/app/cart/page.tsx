      ...
      >
        <div className="absolute top-[60px] left-[50%] transform -translate-x-1/2 text-center">
          <Image
            ...
            height={60}
          />
          <h1 className="text-[48px] font-medium leading-[72px] text-5xl">Cart</h1>
      ...
      <div className="flex flex-col lg:flex-row mt-12 justify-between p-6 bg-white">
                ...
                <tr key={item._id} className="border-b">
                  ...
                  <td className="p-4">
                    <input
                      ...
                      onChange={(e) =>
                        handleQuantityChange(item._id, parseInt(e.target.value), item.price)
                      }
                      className="w-12 border rounded text-center text-gray-700"
                    />
                  </td>
                  <td className="p-4 text-gray-700">${subtotals[item._id]?.toFixed(2)}</td>
                  <td className="p-4">
                    <button
        ...
        <div className="w-full lg:w-1/3 mt-6 lg:mt-0 lg:ml-8">
          <div className="p-6 bg-amber-50 border rounded">
            ...
            <Link href="/checkout" className="block w-full bg-black text-white py-2 rounded text-center">
